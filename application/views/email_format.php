	...
	<body>
		<table class="ios box-wrapper">
			<tbody>
				<tr>
					<td>
						<span><img class="avatar" src="<?=base_url($avatar)?>"></span>
						<span><a href="<?=base_url('/user/detail/'+$assign_by)?>"><?=$username?></a></span>
						...
						<div class="box">
							<div>
								<ul class="nav">
									...
									<li>/</li>
									<li><a href="<?=base_url('/ticket/detail/'.$ticket_id)?>"><?=$ticket_id?></a></li>
								</ul>
							</div>
							<h3 class="title"><a href="<?=base_url('/ticket/detail/'.$ticket_id)?>"><?=$subject?></a></h3>
							<table class="ios-ticket-desc">
								...
								<tr>
									<td class="text-muted">Assign by:</td><td><a href="<?=base_url('/user/detail/'+$assign_by)?>"><?=$username?></a></td>
								</tr>
								<tr>
									<td class="text-muted">Assignee:</td><td><a href="<?=base_url($to_url)?>"><?=$assignee?></a></td>
								</tr>
								<tr>
