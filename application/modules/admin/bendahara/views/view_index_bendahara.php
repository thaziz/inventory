        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="action pull-right">
              ...
              <?php }?>
              <?php if($rules['c']){?>
              <a href="<?=base_url('panel/bendahara/insert_new');?>" class="btn btn-success btn-sm btn-circle"><i class="fa fa-plus"></i> Voucer Peminjaman</a>
              <?php }?>
            </div>
          </div>
          <div class="box-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#ro_table').dataTable({
      ...
      "ajax": {
              "url": "<?php echo base_url('panel/bendahara'); ?>",
              "type": "POST"
          },
      "aaSorting": [[ 1, "desc" ]],
      "searching": true,
      ...
      { "sClass": "center", "aTargets": [ 9 ],
        ...
        if(full[7]=='Nota'){
          ...
          return '<a href=<?=base_url('panel/bendahara/detail');?>/' + full[8]
              ...
              <?php if($rules['e']){?>
              + '</a>'+'<a href=<?=base_url('panel/bendahara/insert');?>/' + full[8]
              + ' class="btn btn-info btn-xs btn-col icon-green"><i class="fa fa-pencil"></i> Voucer Pengembalian'
              <?php }?>
