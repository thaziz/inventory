				        ...
				        <div class="box-body">
				        	<div class="form-group">
				          	...
				          	<div class="form-group">
					            ...
					            <div class="col-sm-4">
					              <input type="text" placeholder="Tahun" name="t_tahun" class="form-control" readonly="" value="<?=date("Y") ?>">
				          	...
				          	<div class="form-group">
					            ...
					            <div class="col-sm-4">
					              <input type="text" placeholder="Saldo" name = "t_nominal" id="t_nominal" class="form-control currency">
					              <span class="info"></span>
					            </div>
				          	</div>
				          	...
				          	<div class="form-group">
					            ...
					            <div class="col-sm-5">
					              <textarea class="form-control" name="t_note" style="height: 100px"></textarea>
					              <span class="info"></span>
					            </div>
				          	</div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('form#admin_form').on('submit', function(e) {
      e.preventDefault();
      $.ajax({
          url : '<?php echo base_url("panel/input_transaksi/insert"); ?>',
          type: "POST",
