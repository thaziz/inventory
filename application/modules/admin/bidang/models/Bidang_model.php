...
class Bidang_model extends CI_Model {
    ...
    private $pref = '';
	var $table = 'divisi';
	var $column_order = array('d_id','d_name','d_code');
	var $column_search =array('d_id','d_name','d_code');
	var $order = array('d_id' => 'asc');
    ...
    public function insert(){
        $_POST['d_created_by'] = $this->session->userdata['name'];
        $_POST['d_date'] = date('Y-m-d h:i:sa');
