        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="action pull-right">
              ...
              <?php }?>
              <?php if($rules['c']){?>
              <a href="<?=base_url('panel/bidang/insert');?>" class="btn btn-success btn-sm btn-circle"><i class="fa fa-plus"></i> Insert</a>
              <?php }?>
            </div>
          </div>
          <div class="box-body">
...
<script type="text/javascript">
  function remove(id){
    if (confirm( "Apakah Kamu Ingin Menghapus Data Bidang?" )) {
      $.ajax({
          url : '<?php echo base_url("panel/bidang/delete"); ?>',
          type: "POST",
          data : {'d_id':[id]},
          dataType: 'json',
  ...
  $(document).ready(function(){
    ...
    $('#admin_table').dataTable({
      ...
      "ajax": {
              "url": "<?php echo base_url('panel/bidang'); ?>",
              "type": "POST"
          },
      "aaSorting": [[ 1, "desc" ]],
      "searching": true,
      ...
      { "sClass": "center", "aTargets": [ 3 ],
        "mRender": function(data, type, full) {
          ...
          return ''
              <?php } ?>
              <?php if($rules['e']){?>
              + ''+'<a href=<?=base_url('panel/bidang/edit');?>/' + full[2]
