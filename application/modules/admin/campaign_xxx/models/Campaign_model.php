...
class Campaign_model extends CI_Model {
    ...
    public function insert(){
        ...
        if($this->db->insert($this->table, $data)){
            ...
            $column[] = 'status VARCHAR(25) NULL COMMENT \'status of data\'';
            ...
            $tbl_camp .= '('.implode(', ',$column).', `callback` datetime DEFAULT NULL, PRIMARY KEY (data_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;';
            //add sql for altering table indexing
            $alt_camp = 'ALTER TABLE data_campaign_'.$id.' '.implode(', ', $index).';';
