...
<style type="text/css">
  ...
  .note>label:hover + .note-content, .note-content:hover{
    display: block;
  }
  .note-content{
    display: none;
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-3">
                            <select name="adv_search[call_status]" class="form-control" id="status">
                              ...
                              <option value="ncy">Not Call Yet</option>
                            </select>
                          </div>
                        </div>
                        <!--div class="form-group">
              ...
              <!-- End advancd search form -->
                      ...
                      <div class="box-header">
                        ...
                        <div class="action pull-right">
                          ...
                          <a class="btn btn-success btn-sm btn-circle" id="export-data"><i class="fa fa-file-excel-o"></i> Export</a>
                      </div>
                      </div>
  ...
  function reload_table(){
    var table = $('#report_table').DataTable({
      ...
      return html;}
        ...
        echo '{ "sClass": "center", "aTargets": [ '.$idx.' ], "data":'.$idx.', "render" : function(data, type, full){
            html = data!=\'\'?\'<a href="#" onclick="window.open(\\\''.base_url('campaign/play/').'\'+data+\'\\\', \\\'Play Recording\\\', \\\'width=315,height=58\\\');" class="btn btn-xs btn-primary">Play</a>&nbsp;&nbsp;<a href="'.str_replace('outbound/','',base_url()).'api/recording/?key=jkHAK23kjhsd223klja677skajskkjsh&filename=\'+data+\'">Download</a>\':\'\';';
            if($wa_enabled==1){
