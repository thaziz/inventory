...
$sql_not_answer = "SELECT COUNT('disposition') AS not_asnswer FROM `cdr` WHERE disposition = 'NO ANSWER' AND calldate >= '2018-12-03 00:00:00' AND calldate <= '2018-12-03 23:59:59'";
$result = $conn->query($sql_not_answer);
if ($result->num_rows > 0){
  $not_answer = $result->fetch_assoc();
}

$sql_busy = "SELECT COUNT('disposition') AS busy FROM `cdr` WHERE disposition = 'BUSY' AND calldate >= '2018-12-03 00:00:00' AND calldate <= '2018-12-03 23:59:59'";
$result = $conn->query($sql_busy);
if ($result->num_rows > 0){
  $busy = $result->fetch_assoc();
}

$sql_not_active = "SELECT COUNT('disposition') AS failed FROM `cdr` WHERE disposition = 'FAILED' AND calldate >= '2018-12-03 00:00:00' AND calldate <= '2018-12-03 23:59:59'";
$result = $conn->query($sql_not_active);
if ($result->num_rows > 0){
  $not_active = $result->fetch_assoc();
}
...
$asm = new AGI_AsteriskManager();
  if($asm->connect())
  {
    $result = $asm->Command("queue show 900");
...
for ($s=0; $s < count($agent_in_call_match); $s++) {
    $arr['agent_in_call'][]=$agent_in_call_match[$s];
}
...
<link rel="stylesheet" href=<?php echo "https://al-tele.dutamedia.com/wallboard/style.css"; ?>>
<link rel="stylesheet" href= <?php echo "https://al-tele.dutamedia.com/wallboard/tester.css"; ?>>
<link rel="stylesheet" href=<?php echo "https://al-tele.dutamedia.com/wallboard/table.css"; ?>>
...
?>
<script src= <?php echo "https://al-tele.dutamedia.com/wallboard/jquery-3.3.1.min.js"; ?>></script>
...
echo "</form>";*/
?>
<table style="width: 100%; height: 55%; border-style: none;">
    <tr>
        <td style="width: 25%; height: 100%;">
            <div id="child-left" class="wallboard_stamp" style = "background-color: #f7ca44;height: 100%; width: 100%;">
        ...
        <td style="width: 25%; height: 100%;">
            <div id="child-left" class="wallboard_stamp" style = "background-color: #fc6b3f;height: 100%;  width: 100%;">
                <div class="stamp_imgBg">
        ...
        <td style="width: 25%; height: 100%;">
            <div id="child-left" class="wallboard_stamp" style = "background-color: #ff2e4c; height: 100%; width: 100%;">
                <div class="stamp_imgBg">
        ...
        <td style="width: 25%; height: 100%;">
            <div id="child-left" class="wallboard_stamp" style = "background-color: #f85959; height: 100%; width: 100%;">
                <div class="">
...
<table style="width: 100%; height: 50%; border-style: none;">
    <tr>
        <td style="width: 25%; height: 100%;">
            <div id="child-left" class="wallboard_stamp" style="background-color: #7da87b; height: 100%; width: 100%;">
                <div class="stamp_imgBg">
        ...
        <td style="width: 25%; height: 100%;">
            <div id="child-left" class="wallboard_stamp" style="background-color: #e6a4b4; width: 100%; height: 100%;">
                <div class="stamp_imgBg">
        ...
        <td style="width: 25%; height: 100%;">
            <div id="child-left" class="wallboard_stamp" style="background-color: #ffb400; width: 100%; height: 100%;">
                <div class="stamp_imgBg">
        ...
        <td style="width: 25%; height: 100%;">
            <div id="child-left" class="wallboard_stamp" style="background-color: #db456f; width: 100%; height: 100%;">
                <div class="stamp_imgBg">
                    ...
                    <?php
                        ...
                        echo '<div class="stamp_copy-blackTxt">'.$b.'%'.'</div>';
                        //}
                    ?>
                </div>
            </div>
...
<table style="width: 100%; height: 50%; border-style: none;">
  <tr>
      <td style="width: 25%; height: 100%;">
          <div id="child-left" class="wallboard_stamp" style="background-color: #5893d4; width: 100%; height: 100%;">
              <div class="stamp_imgBg">
                  <span class="stamp_copy">Not Answer</span>
                  <?php
                      //for ($t=0; $t < count($arr['agent_watting_call']); $t++) {

                      echo '<div class="stamp_copy-blackTxt">'.$not_answer['not_asnswer'].'</div>';
                      //}
                  ?>
              </div>
          </div>
      ...
      <td style="width: 25%; height: 100%;">
          <div id="child-left" class="wallboard_stamp" style="background-color: #23a393; width: 100%; height: 100%;">
              <div class="stamp_imgBg">
                  <span class="stamp_copy">Not Active</span>
                  <?php
                      //for ($t=0; $t < count($arr['agent_watting_call']); $t++) {

                      echo '<div class="stamp_copy-blackTxt">'.$not_active['failed'].'</div>';
                      //}
                  ?>
              </div>
          </div>
      ...
      <td style="width: 25%; height: 100%;">
          <div id="child-left" class="wallboard_stamp" style="background-color: #587850; width: 100%; height: 100%;">
              <div class="stamp_imgBg">
                  <span class="stamp_copy">Reject</span>
                  <?php
                      //for ($t=0; $t < count($arr['agent_watting_call']); $t++) {
      ...
      <td style="width: 25%; height: 100%;">
          <div id="child-left" class="wallboard_stamp" style="background-color: #5893d4; width: 100%; height: 100%;">
              <div class="stamp_imgBg">
                  <span class="stamp_copy">Busy</span>
                  <?php
                      //for ($t=0; $t < count($arr['agent_watting_call']); $t++) {

                      echo '<div class="stamp_copy-blackTxt">'.$busy['busy'].'</div>';
                      //}
                  ?>
              </div>
          </div>
...
<div id="child-left" class="wallboard_stamp" style="display: none;">
    <div class="">
    <span class="stamp_copy">Queue Number</span>
    <?php
