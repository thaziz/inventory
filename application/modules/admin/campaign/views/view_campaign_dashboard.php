                        ...
                        <div class="box-body">
                            <div class = "row">
                                ...
                                <div class = "col-md-4" id="answer-st" data-id = "<?php echo $data->campaign_id; ?>">
                                    ...
                                    <div class="progress-group" id="cancel-st" style="display:none;">
                                        ...
                                        <div class="progress-group" id="chan-st" style="display:none;">
                                            ...
                                            <div class="progress-group" id="chan-st" style="display:none;">
                                                ...
                                                <div class="progress-group" id="chan-st">
                                                    ...
                                                    <span class="progress-number">
                                                        <b>
                                                            <span id = "callback"><?=$call_status->callback?>/
                                                            <?php echo $call_status->total; ?></span></b>
                                                        </span>

                                                        <div class="progress sm">
                                                            <div id = "callback-width" class="progress-bar progress-bar-grey" style="width:<?=($call_status->total>0?($call_status->callback/$call_status->total*100):0)?>%;background-color:#996633;"></div>
                                                        </div>
                                                    </div>
                                            </div>
