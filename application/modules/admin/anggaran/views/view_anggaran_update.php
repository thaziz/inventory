  ...
  <form class="form-horizontal" method="post" id="admin_form">
    <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="form-group form-group-sm" id="div_kategori">
              <input type="text"value="<?=number_format($po['master']->oa_saldo+$po['master']->po_anggaran,0,',','.'); ?>" name="jml_anggaran" id="saldo" class="form-control" placeholder="Jumlah Anggaran" readonly="">        
            </div>
          </div> 
...
<script type="text/javascript">
  $(document).ready(function(){
    $('form#admin_form').on('submit', function(e) {
      e.preventDefault();
      $.ajax({
           url : '<?php echo base_url("panel/anggaran/insert"); ?>',
          type: "POST",
