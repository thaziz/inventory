    ...
    <div class="inbox_msg">
      ...
      <div class="inbox_people2" style="display: none;">
        <div class="headind_srch">
        	<div style=" padding: 10px 10px 10px 10px"><span><strong  class="nama"> </strong></span><span class="pull-right"><strong  class="no_hp"> </strong></span></div>
        </div>
        <div class="headind_srch_all" style="display: none;">
              <div style=" padding: 10px 10px 10px 10px"><span><strong  class="nama_all"> </strong></span><span class="pull-right"><strong  class="no_hp_all"> </strong></span></div>
        </div>
        <div class="mesgs" >
    ...
    function () {
          ...
          if(v.is_reply==1){
            ...
            if(v.quoteText==null && v.quoteImage==null){
             ...
             chats+='<div class="outgoing_msg">'+
                '<div class="sent_msg">'+
                '<p>'+img +' '+v.wa_text+'</p>'+
                '<span class="time_date">'+ v.time+' | '+v.date+' <span class="assign pull-right '+v.status_chat+'" style="font-size: 0.9em;color: #999;margin-top: -8px;"><i class="fa fa-reply"></i> Replied by '+v.agent_name+'</span></span>'+
                '</div>'+
                '</div>';
      ...
      /*  else if(tabn==1){
        ...
        if(data.history_chat=='ack'){
          console.log('op'+v.id);
          console.log('op'+v.status);
        var r='<img src="'+url_base+'assets/images/'+v.status+'.png" width="17px" height="17px">';   
            $('.'+v.id).text('');
            return false;
        }
