    ...
    <div class="inbox_msg">
      ...
      <div class="inbox_people2" style="display: none;">
        <div class="headind_srch">
            ...
            <span ><button class="btn btn-primary btn-xs" onclick="assigment()">Assignment My chat</button></span>
    ...
    <div class="modal-content">
      ...
      <form role="form" id="form-assign">
          ...
          <div class="row">
            <div class="col-md-11 px-20" style="width: 96%;">
              <div class="form-group">
                <input type="" name="hp" id="hp_assign">
...
$('#form-assign').on('submit', function(e){
   ...
   $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: 'phone='+$('#hp_assign').val()+'&number='+<?=$number ?>+'&type=<?=$type ?>',
          }).done(function(res){
            if(res.status){
              $().toastmessage('showToast', {
                        text     : 'Close chat success',
