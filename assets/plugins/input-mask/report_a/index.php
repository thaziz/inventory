...
function listTicket($pDB, $smarty, $module_name, $local_templates_dir){
    ...
    $url = 'https://localhost'.str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']).'kanmo/report_agent_activity_nespresso/index/nespresso/3ec8112b9e277cf4d24c85136fc9ee95?issabel_user='.$_SESSION['issabel_user'];
