			...
			<div class="row">
				<div class="col-md-12 col-sm-12" id="content">
					<form id="form_ticketing" role="form" class="form-horizontal">
						...
						<?php else:?>
							<div class="alert alert-warning text-center" style="display: <?=!empty($phone)?'block':'none'?>;"><i>Number is not registered</i></div>
						<?php endif;?>
						...
						<div class="flex">
							<div class="col-md-7 col-sm-7" style="border-radius: 5px;border: 1px solid #ccc;">
								<div class="form-group" style="margin-bottom: 5px;">
									<label class="col-md-12 col-sm-12" style="font-size: 1.2em">Ticket Form</label>
										...
										<?php elseif($call_id==0):?>
											...
											<div class="input-group">
												...
												<div class="input-group-btn">
													<button type="button" class="btn btn-success" id="btn-call"><i class="fa fa-phone"></i> Call</button>
												</div>
											</div>
										<?php endif;?>
								...
								<div class="form-group">
									<label class="col-md-3 col-sm-3 mt-5" for="ticket_id">Brand <span class="required">*</span></label>
									<div class="col-md-9 col-sm-9">
									...
									<div class="col-md-9 col-sm-9">
										<div class="col-md-5 col-sm-5 p-0">
											<select name="main_category" class="form-control">
												...
												<?php foreach ($main_category as $key => $b) {
													//if($b['id']!=3)
							                  		echo '<option value="'.$b['id'].'">'.$b['text'].'</option>';
							                 	}?>
											</select>
								...
								<div class="form-group">
									...
									<div class="col-md-9 col-sm-9">
										<div class="col-md-5 col-sm-5 p-0">
											<select name="meta_category" class="form-control" id="se">
								...
								<div class="form-group" id="panel-callback">
							...
							<div class="col-md-4 col-sm-4 flex flex-column p-0" style="width:40%;max-height:770px;margin-left:10px;overflow-y:auto;">
								...
								<div style="border-radius: 5px;border: 1px solid #ccc; margin-bottom: 10px">
									...
									<div class="form-group cus-field-info">
										...
										<label class="col-md-7 col-sm-7 info-value">: <span class="ftext" id="current_slab"><?=$current_slab?></span></label>
										<input type="hidden" name="current_slab" value="<?=$current_slab?>">
									</div>
									<div class="form-group cus-field-info">
										<label class="col-md-5 col-sm-5" for="callback">Loyalty Points</label>
										<label class="col-md-7 col-sm-7 info-value">: <span class="ftext" id="loyalty_points"><?=$loyalty_points?></span></label>
										<input type="hidden" name="loyalty_points" value="<?=$loyalty_points?>">
									</div>
									<!--div class="form-group cus-field-info">
										<label class="col-md-5" for="callback">Registered on</label>
										<label class="col-md-7 info-value">: <span><?=date('d F Y', strtotime($registered_on))?></span></label>
									...
									<div class="form-group cus-field-info">
										...
										<label class="col-md-7 col-sm-7 info-value">: <span class="ftext" id="fraud_status"><?=$fraud_status?></span></label>
										<input type="hidden" name="fraud_status" value="<?=$fraud_status?>">
									</div>
									<div class="form-group cus-field-info">
								...
								<div class="tab-content">
  									<div id="transaction" class="tab-pane fade in active">
										<div class="form-group" style="margin-top: 15px;margin-bottom: 5px;">
											<label class="col-md-5 col-sm-5 pull-left" style="font-size: 1.2em">Customer Transaction</label>
											<div class="col-md-7 col-sm-7" style="padding-left:0;">
												<div class="col-md-6 col-sm-6 p-0">
													<label class="col-md-3 col-sm-3" style="margin-top:5px;">Periode</label>
													<div class="col-md-9 col-sm-9" style="padding-right:0;">
														<input type="text" class="form-control input-sm fperiode" placeholder="Periode" value="<?=!empty($fields['last_sale_date'])?date('F d, Y', strtotime($fields['last_sale_date'].' -3 months')).' - '.date('F d, Y', strtotime($fields['last_sale_date'].' 1 day')):''?>">
													</div>
												</div>
												<div class="col-md-5 col-sm-5">
									...
									<div id="ticket_history" class="tab-pane fade in">
										<div class="form-group" style="margin-top: 15px;margin-bottom: 5px;">
											...
											<div class="col-md-4 col-sm-4" style="padding-left:0;">
												...
												<!--div class="col-md-5">
													<label class="col-md-2" style="margin-top:5px;">Store</label>
...
<!-- Modal Ticket -->
<div id="detail-ticket" class="modal fade" role="dialog">
...
<div id="new-customer" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg" style="width: 100%;height: 100%;margin-top:0;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title" id="title-form-new">New Customer Registration</h4>
      </div>
      <div class="modal-body">
      	...
      	<div class="row">
	      	<div class="col-md-4 col-sm-4">
		      	...
		      	<div class="form-group">
		      		...
		      		<input type="text" name="firstname" id="nfname" class="form-control">
		      	</div>
		    </div>
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		<label class="form-label">Last Name<span class="required">*</span></label>
		      		<input type="text" name="lastname" id="nlname" class="form-control">
		      	</div>
		    </div>
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		<label class="form-label">Email<span class="required">*</span></label>
		      		<input type="email" name="email" id="nemail" class="form-control">
		      	</div>
		    </div>
		</div>
      	<div class="row">
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		...
		      		<input type="text" name="mobile" id="nphone" class="form-control">
		      	</div>
		    </div>
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		<label class="form-label">Bar Code<span class="required">*</span></label>
		      		<input type="text" name="external_id" id="nbarcode" class="form-control">
		      	</div>
		    </div>
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		...
		      		<div class="col-md-12 col-sm-12 p-0">
		      			<label class="radio-inline" style="margin-right: 25px;">
		      				<input type="radio" name="field[gender]" value="MALE" id="ngender_MALE"> Male
		      			</label>
		      			<label class="radio-inline">
		      				<input type="radio" name="field[gender]" value="FEMALE" id="ngender_FEMALE"> Female
		      			</label>
		      		</div>
		      	</div>
		    </div>
      	...
      	<div class="row">
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		...
		      		<input type="text" name="field[dob_mom]" id="ndob_mom" class="form-control datepicker">
		      	</div>
		    </div>
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		<label class="form-label">Country of Origin<span class="required">*</span></label>
		      		<input type="text" name="field[country_origin]" id="ncountry_origin" class="form-control">
		      	</div>
		    </div>
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		<label class="form-label">Company</label>
		      		<input type="text" name="field[company]" id="ncompany" class="form-control">
		      	</div>
		    </div>
		</div>
      	<div class="row">
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		...
		      		<input type="text" name="field[address_one_home_one]" id="nadd1" class="form-control">
		      	</div>
		    </div>
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		<label class="form-label">Address 2</label>
		      		<input type="text" name="field[address_one_home_two]" id="nadd2" class="form-control">
		      	</div>
		    </div>
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
      	...
      	<div class="row">
	      	...
	      	<div class="col-md-4 col-sm-4">
		      	<div class="form-group">
		      		...
		      		<input type="text" name="field[zip_code]" id="nzip_code" class="form-control">
		      	</div>
		    </div>
		</div>
      	<div class="row">
	      	...
	      	<div class="col-md-12 col-sm-12">
		      	<div class="form-group">
		      		...
		      		<div class="col-md-12 col-sm-12 p-0">
		      			...
		      			<!--label class="checkbox-inline">
		      				<input type="checkbox" name="field[brand_interest][]" class="bi bi_etc" id="bi_etc" value="Etc"> Etc
		      			</label-->
		      		</div>
		      	</div>
		    </div>
...
<div class="loading" style="display: flex; align-items: middle; justify-content: center; position: fixed; width: 100vw; height: 100vh; "><i class="fa fa-circle-o-notch fa5x"></i></div>
		...
		function table_detail(trans_id){
			...
			var store = $('.fstore').val();
		      var table = $('#table-items').on( 'processing.dt', function ( e, settings, processing ) {
		        ...
		        responsive: false,
		        "ajax": {
	                "url": "<?=base_url('api/kanmo/get_trans_detail/3ec8112b9e277cf4d24c85136fc9ee95'); ?>",
	                "type": "POST",
		...
		function show_detail_ticket(e,t_id){
			e.preventDefault();
			$('#detail-ticket').modal('show').find('.modal-body').html('<div class="flex" style="justify-content: center;align-content: middle;color:#ddd;"><i class="fa fa-circle-o-notch fa-spin fa-5x fa-fw"></i></div>');
			...
			$('#detail-ticket').on('shown.bs.modal', function(){
				$('#detail-ticket').find('.modal-body').load('<?=base_url('api/ticket/detail/kanmo/')?>3ec8112b9e277cf4d24c85136fc9ee95?ticket_id='+t_id+'&editable=0');;
			})
			/*})
		...
		function reload_table(){
			...
			var store = $('.fstore').val();
		      var table = $('#table-trans').on( 'processing.dt', function ( e, settings, processing ) {
		        ...
		        responsive: false,
		        "ajax": {
	                "url": "<?=base_url('api/kanmo/get_trans/3ec8112b9e277cf4d24c85136fc9ee95'); ?>",
	                "type": "POST",
		...
		function reload_table_ticket(){
			...
			//var store = $('.tstore').val();
		      var table = $('#table-ticket').on( 'processing.dt', function ( e, settings, processing ) {
		        ...
		        responsive: false,
		        "ajax": {
	                "url": "<?=base_url('api/kanmo/get_ticket/3ec8112b9e277cf4d24c85136fc9ee95'); ?>",
	                "type": "POST",
	                "data": {'phone':$('#phone').val(), 'periode':periode/*, 'store':store*/},
	            },
		        "aaSorting": [[ 5, "asc" ]],
	    ...
	    $('#find-subcat').on('keyup', function(){
	    	...
	    	clearTimeout(typingTimer);
  			typingTimer = setTimeout(function(){
  				$.ajax({url:'<?=base_url('api/kanmo/show_subcat_info')?>', data:{'subcat':subcat}, type:'post', dataType:'text'})
		    	.done(function(res){
...
$('#ncity').change(function(){
	...
	if(city!==null && city!==''){
	    ...
	    function search(){
	    	...
	    	$.when(
	    		$.ajax({
	    		url: '<?=base_url('api/kanmo/search_add/3ec8112b9e277cf4d24c85136fc9ee95')?>',
	    ...
	    $('#form-new').submit(function(e){
	    	...
	    	$.when(
	    	$.ajax({
	    		url:'<?=base_url('api/kanmo/save_customer')?>',
	    		type: 'post',
	    		dataType: 'json',
	    ...
	    var init = true;
		  ...
		  $(document).ready(function(){
		  	...
		  	$('#bi_etc').change(function(){
		  		if($(this).prop('checked')){
		  			$('.bi:not(.bi_etc)').prop('checked', false);
		  			$('.bi:not(.bi_etc)').prop('disabled', true);
		  		}else{
		  			$('.bi:not(.bi_etc)').prop('disabled', false);
		  		}
		  	})
		  	//Date picker
			...
			$('.loading').hide();
		  	...
		  	$('[name="main_category"]').change(function(){
		  		...
		  		$.post('<?=base_url('api/kanmo/get_meta_category')?>',{'id':id})
		  		.done(function(res){
		  	...
		  	$('[name="meta_category"]').change(function(){
		  		...
		  		$('[name="category"]').html('<option value=""> --Category-- </option>');
		  		$('[name="sub_category"]').html('<option value=""> --Sub Category-- </option>');
		  		$.post('<?=base_url('api/kanmo/get_category')?>',{'id':id})
		  		.done(function(res){
		  			var data = JSON.parse(res);
		  			$.each(data, function(i,v){
		  	...
		  	$('[name="category"]').change(function(){
		  		var id = $(this).val();
		  		$('[name="sub_category"]').html('<option value=""> --Sub Category-- </option>');
		  		$.post('<?=base_url('api/kanmo/get_subcategory')?>',{'id':id})
		  		.done(function(res){
		  			var data = JSON.parse(res);
		  			$.each(data, function(i,v){
		    ...
		    $('form#form_ticketing').on('submit', function(e) {
		      ...
		      $.ajax({
		          url : "<?=base_url('api/kanmo/save_ticket/'.$auth)?>",
		          type: "POST",
