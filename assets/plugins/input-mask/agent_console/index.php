...
function manejarSesionActiva_HTML($module_name, &$smarty, $sDirLocalPlantillas, $oPaloConsola, $estado, $listpanels)
{
    ...
    if(isset($_SESSION['issabel_user'])){
        if(in_array($_SESSION['issabel_user'], array(807, 808,8111))){
            $userType = 'NESPRESSO';
        }else if(in_array($_SESSION['issabel_user'], array(802, 803, 804, 805, 806, 809, 810, 811))){
            $userType = 'KANMO';
        }
    }
    ...
    $smarty->assign(array(
        ...
        'USER_EXT'       =>  isset($_SESSION['issabel_user'])?$_SESSION['issabel_user']:'',
        'USER_TYPE'       =>  $userType,
    ));
    $estadoInicial = array(
