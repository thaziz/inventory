					...
					<form class="form-horizontal" method="post" id="campaign_form">
				        <div class="box-body">
				          	...
				          	<div class="form-group">
					            ...
					            <div class="col-sm-2  col-xs-4">
				              		<input type="text" name="target_per_month" id="target_per_month" class="form-control currency">
					              	<span class="info"></span>
					            </div>
				          	</div>
      ...
      $('#type-'+idx).change(function(){
        ...
        if(type=='number'){
          ...
          $(rel).html(html);
      		...
      		html = '<div class="col-md-12" style="margin-left:5px;"><label class="checkbox" title="Only one field can have this value"><input type="checkbox" name="el['+itemid+'][wbval]">As Wallboard Value</label></div>';
          $(rel).html(html);
      	}else{
